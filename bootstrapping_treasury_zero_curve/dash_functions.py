...
import pandas as pd
from . import run_functions

def create_dashboard(server):
        spotData, forwardData, ymax, ymin = run_functions.run_functions()
        ...
        dashApp.layout = html.Div(children = [
                ...
                dcc.Slider(id = "date-slider-input", min = 0, max = len(dateList) - 1,
                        value = 0, step = 1)])
        #intialize callbacks
        init_callbacks(dashApp, spotData, forwardData, ymax, ymin, colors, dateList)
